...
| 03 김현우 v10 (TFT×10 trim3)| 11,413   | 0.6128         | +41%  |
| **03 김현우 v11 (TFT×5 + BiLSTM×5)** | **10,521** | **0.6422** 🏆 | **+48%** |

> **v11 핵심 발견**: BiLSTM이 Train3·4 (어려운 베어링) 에서 TFT 압도
> - TFT × 5 + BiLSTM × 5 = 40 모델 앙상블 (4 folds × 10 seeds)
> - Train3 (89 측정, 약한 열화): TFT 평균 0.39 → BiLSTM 평균 0.58
> - Train4 (137 측정, 약한 열화): BiLSTM/9999 단독 0.5962 (최고)
> - 작은 데이터·약한 신호에서 BiLSTM의 inductive bias 우수
> - Score loss curriculum (ep 30+) + asym 손실 결합
