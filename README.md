...
### 베어링별 AsymScore — v6 vs 다른 팀

| 베어링  | 01 경민(OT) | 02 태환(SCNN) | 03 김현우 v1 | **03 김현우 v6** |
|---------|:----------:|:------------:|:-----------:|:---------------:|
| Train1  | 0.4433     | 0.5191       | 0.3697      | **0.7522** 🔥   |
| Train2  | 0.5414     | 0.4552       | 0.5116      | **0.7021** 🔥   |
| Train3  | 0.4066     | 0.2712       | 0.4584      | **0.4763** 🔥   |
| Train4  | 0.4245     | 0.4421       | 0.3953      | **0.4458**      |
...
| **03 김현우 v6 (TFT×5 + trim)** | **12,402** | **0.5901** 🏆 | **+36%** |

> **v6 핵심**: TFT × 5 seeds + trimmed mean (worst 1 제거)
> - 비대칭 손실 부호 버그 수정 (늦은 예측 2.5× 페널티)
> - 시드 5개로 outlier 자동 제거 (Train3: seed42/99 둘 다 outlier → trim으로 회복)
> - 베어링별 best 전략: Train1·2 median, Train3·4 trimmed
> - DTC-VAE latent 4차원, 베어링별 단조성 강제
> - Asym-score 기반 early stopping (patience 70)
> - Test1~6 submission.xlsx 자동 생성
