...
### 베어링별 AsymScore — v3 vs 다른 팀

| 베어링  | 01 경민(OT) | 02 태환(SCNN) | 03 김현우 v1 | **03 김현우 v3** |
|---------|:----------:|:------------:|:-----------:|:---------------:|
| Train1  | 0.4433     | 0.5191       | 0.3697      | **0.7438** 🔥   |
| Train2  | 0.5414     | 0.4552       | 0.5116      | **0.7086** 🔥   |
| Train3  | 0.4066     | 0.2712       | 0.4584      | 0.4507          |
| Train4  | 0.4245     | 0.4421       | 0.3953      | **0.4437**      |
...
> **v3 핵심 개선** (v1 0.43 → v3 0.58, +34%):
> - 비대칭 손실 부호 버그 수정 (늦은 예측 2.5× 페널티)
> - TFT × 3 seeds (median voting → outlier robust)
> - 보수적 보정 (μ - 0.15σ_GPR - 0.10σ_seeds)
> - DTC-VAE latent 4차원 확장, 베어링별 단조성 강제
> - Asym-score 기반 early stopping
