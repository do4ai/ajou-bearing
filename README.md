...
### 베어링별 AsymScore — v9 vs 다른 팀

| 베어링  | 01 경민(OT) | 02 태환(SCNN) | 03 김현우 v1 | **03 김현우 v9** |
|---------|:----------:|:------------:|:-----------:|:---------------:|
| Train1  | 0.4433     | 0.5191       | 0.3697      | **0.7577** 🔥   |
| Train2  | 0.5414     | 0.4552       | 0.5116      | **0.7319** 🔥   |
| Train3  | 0.4066     | 0.2712       | 0.4584      | **0.5027** 🔥   |
| Train4  | 0.4245     | 0.4421       | 0.3953      | **0.4532** 🔥   |
...
| 03 김현우 v1 (Ensemble)| 14,192        | 0.4337         | -     |
| 03 김현우 v3 (TFT×3)   | 12,096        | 0.5822         | +34%  |
| 03 김현우 v6 (TFT×5 trim1)  | 12,402   | 0.5901         | +36%  |
| 03 김현우 v8 (+score loss)  | 11,987   | 0.5962         | +37%  |
| **03 김현우 v9 (TFT×7 trim2)** | **11,606** | **0.6082** 🏆 | **+40%** |

> **v9 핵심**: TFT × 7 seeds + trim 2 (worst 2 outlier 제거)
> - 비대칭 손실 부호 버그 수정 (늦은 예측 2.5× 페널티)
> - Score loss curriculum (ep 30+ 부터 평가지표 직접 최적화)
> - MIN_EPOCHS 80 강제 (score loss 단계 도달 보장)
> - Augmentation noise σ=0.035 (강화)
> - **Train3 0.50 돌파** (가장 어려운 베어링, v1 0.46 → v9 0.50)
> - DTC-VAE latent 4차원, 베어링별 단조성 강제
> - Test1~6 submission.xlsx 자동 생성 (28 모델 앙상블)
