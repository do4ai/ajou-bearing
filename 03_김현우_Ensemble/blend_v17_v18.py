...
MODEL_DIR_V18 = METHOD_DIR / "models_v18"
...
rec.to_csv(RESULT_DIR / "blend_v17v18_grid.csv", index=False)
print("\n  ── Top 10 by full ──")
...
plt.tight_layout()
plt.savefig(RESULT_DIR / "blend_v17v18_LOBO.png", dpi=120); plt.close()
...
out_full = RESULT_DIR / "submission_v19_blend_full.xlsx"
out_comb = RESULT_DIR / "submission_v19_blend_combined.xlsx"
...
out_df.to_csv(RESULT_DIR / "submission_v19_blend_debug.csv", index=False)
print(f"\n  → {out_full}")
print(f"  → {out_comb}")
